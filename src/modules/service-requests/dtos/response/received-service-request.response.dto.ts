...
class ReceivedServiceSummaryDto {
  @ApiProperty({
...
class CustomerSummaryDto {
  ...
  @ApiProperty({
    description: 'Apellido del cliente que realizó la solicitud',
    example: 'Pérez',
  })
...
export class ReceivedServiceRequestResponseDto {
  ...
  @ApiProperty({ type: ReceivedServiceSummaryDto })
  declare service: ReceivedServiceSummaryDto;

  @ApiProperty({ type: CustomerSummaryDto })
  declare customer: CustomerSummaryDto;
